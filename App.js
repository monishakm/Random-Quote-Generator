...
class App extends React.Component {
  ...
  render() {
    return (
      ...
      <h5 className='bg-purple-300 text-black-100 text-center py-2 flex-row'> <span>Made By <span className='animate-bounce'>--</span> </span><a href='https://moniresume.my.canva.site/monisha' className='bg-sky-300 underline rounded p-0.5 px-1  '>Monisha </a>🌎</h5>
      </div>
      </>
    );
  }
